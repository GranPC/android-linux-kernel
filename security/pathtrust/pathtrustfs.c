...
#ifdef CONFIG_BBSECURE_PATHTRUST_DEVELOP
int pathtrust_debug = 0;
#endif

#ifdef CONFIG_BBSECURE_PATHTRUST_BOOTPARAM
...
#endif
#ifdef CONFIG_BBSECURE_PATHTRUST_SELINUX
...
#endif /* CONFIG_BBSECURE_PATHTRUST_DEVELOP */
 ...
 * Returns number of bytes written or error code, as appropriate
 */
#ifndef CONFIG_BBSECURE_PATHTRUST_DEVELOP
...
#endif /* CONFIG_BBSECURE_PATHTRUST_SELINUX */
